...
UNexusCreateSessionProxy* UNexusCreateSessionProxy::CreateNexusSession(UObject* InWorldContextObject, const FNexusHostParams& InHostParams, FName InSessionName /*= NAME_None*/)
{
